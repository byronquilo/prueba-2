<%-- 
    Document   : index
    Created on : 16/02/2020, 11:14:08
    Author     : Bayron
--%>
...
<html>
    <head>
        ...
        <script src="java/newjavascript.js" type="text/javascript"></script>
        <title>JSP Page</title>
    </head>
    <body>
        <form action="procesoServlet" name="Formulario"   method="post"  >
           <div class="principal">
                ...
                <table >
                    ...
                    <tr class="tr48"  >
                        <td colspan="2" >2. Número de Documento de Identificación:</br> 
                            <input type="text" name="numerocedula" class="cedula" maxlength="10" onkeypress="return solonumeros(event)" >
                        </td>
                        <td  colspan="4">3. Sexo:   
                    ...
                    <tr class="tr16" >
                        <td class="borde1" colspan="9">5. Apellidos y Nombres del Estudiante: Nombre:
                            <input type="text" name="papellido" class="nombre" maxlength="50" placeholder="1er Apellido">
                            <input type="text" name="sapellido" class="nombre" maxlength="50"placeholder="2do Apellido" >
                            <input type="text" name="pnombre" class="nombre" maxlength="50"placeholder="1er Nombre" >
                            <input type="text" name="snombre" class="nombre" maxlength="50" placeholder="2do Nombre">
                    ...
                    <tr>
                        <td colspan="4"> 11. En caso de emergencia contactar a: (Apellidos y Nombres)
                            <input type="text" name="emergenciapapellido" class="emergencia1" maxlength="50" placeholder="1er Apellido">
                            <input type="text" name="emergenciasapellido" class="emergencia1" maxlength="50"placeholder="2do Apellido" >
                            <input type="text" name="emergenciapnombre" class="emergencia1" maxlength="50"placeholder="1er Nombre" >
                            <input type="text" name="emergenciasnombre" class="emergencia1" maxlength="50" placeholder="2do Nombre">
                        </td>
                        <td colspan="3">  12. Parentesco: 
                            <input type="text"  name="parentesco" id="parentesco" maxlength="20" >
                        </td>
                        <td colspan="2">13. Nro. de Contacto: 
                            <input type="text" name="contactopariente" class="celular" onkeypress="return solonumeros(event)" maxlength="10" >
                        </td>
                    ...
                    <tr class="tr16">
                        <td colspan="9" >15. En caso de escoger etnia Indígena u Otro especifique su nacionalidad:<input type="text"  name="casodeetnia" class="direc" maxlength="50" ></td>
                    </tr>
                    <tr class="tr16">
                    ...
                    <tr class="tr48">
                        <td colspan="4">  17. Fecha de Nacimiento: (Año-Mes-Dia)<input type="date"  name="fecha" id="idfecha" onchange="validarFecha(this.value);" > </td><td colspan="3">  17.1 Edad:<input type="text" name="edad" class="espacio3" maxlength="2" onkeypress="return solonumeros(event)"  > </td>
