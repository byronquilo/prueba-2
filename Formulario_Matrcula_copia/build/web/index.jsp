<%-- 
    Document   : index
    Created on : 23 ene. 2020, 05:22:00
    Author     : Bayron
--%>
        ...
        <from >
                ...
                <table >
                    ...
                    <tr class="tr32">
                        <td colspan="9"> 1. Tipo de Documento de Identificación:
                            <input type="radio" name="identificacion" id="idcedula" valies="cedula ">
                            <label for="idcedula" >Cedula</label>
                            <input type="radio" name="identificacion" id="idpass" valies="pasaporte "> 
                    ...
                    <tr>
                        <td colspan="4"> 11. En caso de emergencia contactar a: (Apellidos y Nombres)<input type="text"  name="casoemergencia" id="casoemergencia" class="mail" ></td><td colspan="3">  12. Parentesco: <input type="text"  name="parentesco" id="parentesco" ></td><td colspan="2">13. Nro. de Contacto: <input type="tel" name="contacto" class="celular" ></td>
                    ...
                    <tr class="tr16">
                        <td colspan="9" >15. En caso de escoger etnia Indígena u Otro especifique su nacionalidad:<input type="text"  name="casodeetnia" id="casodeetnia" class="espe"  ></td>
                    </tr>
                    <tr class="tr16">
                        <td colspan="9" >16. Habla algún idioma ancestral: 
                            ...
                            Especifique:
                            <input type="text"  name="especifique" id="especifique" class="mail" >
                        </td>
                    </tr>
                    <tr class="tr48">
                    ...
                    <tr class="tr32" >
                        <td colspan="2" >19. País de Nacionalidad:<input type="text" name="paisn" ></td><td  colspan="4">20. Provincia de Nacimiento:<input type="text" name="provincian" > <td colspan="3" >21. Cantón de Nacimiento:<input type="text" name="cantonn" ></td>
                    </tr>
                    <tr class="tr48">
                    ...
                    <tr class="tr32" >
                        <td colspan="2"  >23. País de Residencia:<input type="text" name="paisn" ></td><td  colspan="4">24. Provincia de Residencia:<input type="text" name="provincian" > <td colspan="3">25. Cantón de Residencia:<input type="text" name="cantonn" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="tr16">
                        ...
                        <td colspan="6">   28. Nro. Carnet CONADIS:
                            <input type="number" name="conadis" ></td>
                    </tr>
                    <tr class="tr48">
                        ...
                        <td colspan="7">   30. Tipo:
                            ...
                            <input type="radio" name="tipo" id="idFísica" valies="Física "> 
                            <label for="idFísica" >Física</label>
                            <input type="radio" name="tipo" id="idVisual " valies="Visual  "> 
                            <label for="idVisual " >Visual </label>
                            <input type="radio" name="tipo" id="idOtra" valies="Otra "> 
                            <label for="idOtra" >Otra</label></br>
                            <input type="radio" name="tipo" id="idIntelectual" valies="Intelectual " class="espacioradio"> 
                            <label for="idIntelectual" >Intelectual</label> 
                            <input type="radio" name="tipo" id="idMental " valies="Mental  "> 
                            <label for="idMental " >Mental</label>
                            <input type="radio" name="tipo" id="idNA " valies="NA  "> 
                    ...
                    <tr class="tr16">
                        <td colspan="9" >34. Posee algún título de Educación Superior: 
                            ...
                            Especifique el título: <input type="text"  name="especifique" id="especifique" class="cedula" >
                        </td>
                    </tr>
                    <tr class="tr48">
            ...
            <div class="hoja2">
                ...
                <table >
                    ...
                    <tr class="tr16" >
                        <td colspan="9" class="tdblanco3"  >53. Ha participado en algún Proyecto de Vinculación con la Sociedad en el Instituto:
                    ...
                    <tr class="tr16" >
                        <td colspan="9"   >56. Cuál es el nombre de la empresa donde labora: <input type="text" name="empresa" class="mail" > </td>
                    </tr>
                    <tr class="tr16">
                    ...
                    <tr class="tr32" >
                        <td colspan="9" class="tdblanco3"  >58. Para que emplea sus ingresos económicos el estudiante:</br>
                    ...
                    <tr class="tr64" >
                        <td colspan="1" class="tdblanco1"  >61. Nivel de Formación de la Madre:  </br>
                    ...
                    <tr class="tr16">
                        <td colspan="4" class="tdblanco3">62. Ingresos del Hogar:<input type="number" name="ingreso" class="espacio2" >  $ </td> <td colspan="5" class="tdblanco3">63. Número de Miembros del Hogar:<input type="number" name="hogar" class="espacio2" > </td>
                    </tr>
                    <tr class="tr48" >
                        <td colspan="9" class="derecha"  >FIRMA ESTUDIANTE: _______________________________________</td>
                    </tr>
                    <tr class="tr16" >
                        <td colspan="9" class="derecha"  >Pág. 2 de 2 </td>
                    </tr>
                </table>
            </div>
