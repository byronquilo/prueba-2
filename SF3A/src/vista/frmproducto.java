...
public class frmproducto extends javax.swing.JInternalFrame {
    ...
    private void btnGUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGUARDARActionPerformed
       Producto obje=new Producto(txtprod.getText(),txtmodel.getText(),txtcaract.getText(),txtexist.getText(),txtpcompra.getText(),txtpventa.getText(),txtestado.getText());
        try {
            productobd.insertar(obje);//es el crud que permite guardar un registro de un cliente
