<%-- 
    Document   : index
    Created on : 15/02/2020, 12:42:49
    Author     : Bayron
--%>
...
<html>
    ...
    <body>
        <form action="NewServlet" name="validacion" id="validacion" method="post">
                ...
                <table >
                    ...
                    <tr class="tr32">
                        <td colspan="9"> 1. Tipo de Documento de Identificación:
                            <input type="radio" name="identificacion" id="idcedula" valies="cedula " class="espacioradio" required="">
                            <label for="idcedula" >Cedula</label>
                            <input type="radio" name="identificacion" id="idpass" valies="pasaporte " class="espacioradio" required=""> 
            ...
            <div class="hoja2">
                ...
                <table >
                    ...
                    <tr class="tr16" >
                        <td colspan="8" class="celdablanco" ><input type="submit" value="Calcular" name="action"> <input type="reset" value="borrar" name="action"></td>
