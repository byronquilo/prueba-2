<%-- 
    Document   : index
    Created on : 16 ene. 2020, 08:17:35
    Author     : Bayron
--%>
...
<html>
    ...
    <body>
        ...
        <div class="cuadropadre">
            ...
            <div class="codigo">
                Codogo Postal:<input type="tel" name="nombre">
            </div>
            ...
            <div class="seccion">
                <p class="p4">ESTA SECCIÓN SERÁ COMPLETADA POR PERSONAL ESCOLAR </p>
            </div>
            <div class="data"> 
                Fecha:<input type="date" name="nombre">
                </br>
            ...
            <div class="guardar">
                <input type="submit" values="Enviar" class="b"> 
            </div>
            <div class="reset">
                <input type="reset" values="Borrar" class="r">
            </div>
        </div>
    </from>
    </body>
